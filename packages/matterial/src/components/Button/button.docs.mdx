...
```jsx
<Button shape="circle"><Icon.Notification /></Button>
<Button shape="circle" variant="outlined"><Icon.Notification /></Button>
<Button shape="circle" variant="contained"><Icon.Notification /></Button>
<Button shape="square" variant="outlined"><Icon.Notification /></Button>
<Button shape="square" variant="contained"><Icon.Notification /></Button>
```

## Icon Button Content

<Container row>
  <Button prepend={<Icon.Notification />} variant="contained">Alerts</Button>
  <Button append={<Icon.Notification />} variant="contained">Alerts</Button>
  <Button prepend={<Icon.Notification />} append={<Icon.Notification />} variant="contained">So Many Alerts</Button>
</Container>

```jsx
<Button prepend={<Icon.Notification />}>Alerts</Button>
<Button append={<Icon.Notification />}>Alerts</Button>
<Button prepend={<Icon.Notification />} append={<Icon.Notification />}>So Many Alerts</Button>
```
